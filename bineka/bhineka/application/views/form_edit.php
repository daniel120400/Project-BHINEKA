          ...
          <center><font size="6">Edit Data</font></center>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 ">
                <input type="text" name="kode" value="<?php echo $dat['kd_brg']; ?>" class="form-control" size="4" required >
              </div>
            </div>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6">
                <input type="text" name="nama" value="<?php echo $dat['nm_brg']; ?>" class="form-control" required>
              </div>
            </div>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 ">
                <input type="text" name="satuan" value="<?php echo $dat['satuan']; ?>" class="form-control" size="4" required>
              </div>
            </div>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6">
                <input type="text" name="harga" value="<?php echo $dat['harga']; ?>" class="form-control" required>
              </div>
            </div>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 ">
                <input type="text" name="beli" value="<?php echo $dat['harga_beli']; ?>" class="form-control" size="4" required>
              </div>
            </div>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6">
                <input type="text" name="stok" value="<?php echo $dat['stok']; ?>" class="form-control" required>
              </div>
            </div>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 ">
                <input type="text" name="min" value="<?php echo $dat['stok_min']; ?>" class="form-control" size="4" required>
              </div>
            </div>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6">
                <input type="text" name="gambar" value="<?php echo $dat['gambar']; ?>" class="form-control" required>
              </div>
            </div>
